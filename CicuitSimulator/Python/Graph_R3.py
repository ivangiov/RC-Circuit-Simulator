...
img = mpimg.imread('Resources/R3.png')											#Memuat file .png ke variabel img
...
fig1.canvas.set_window_title('Gambar Rangkaian 3')								#Mengubah window title
...
#Membaca file csv
data = pd.read_csv(r"Output\R3.csv")
...
arus = pd.concat([i1,i2], axis = 1)
tegangan = pd.concat([va], axis = 1)
...
fig2.canvas.set_window_title('Grafik Tegangan dan Arus Rangkaian 3')

#Menyimpan figure 2 dalam bentuk png
plt.savefig('Output\R3.png', bbox_inches='tight', dpi=1000)
