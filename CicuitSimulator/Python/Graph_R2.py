...
img = mpimg.imread('Resources/R2.png')											#Memuat file .png ke variabel img
...
fig1.canvas.set_window_title('Gambar Rangkaian 2')								#Mengubah window title
...
#Membaca file csv
data = pd.read_csv(r"Output\R2.csv")
...
fig2.canvas.set_window_title('Grafik Tegangan dan Arus Rangkaian 2')

#Menyimpan figure 2 dalam bentuk png
plt.savefig('Output\R2.png', bbox_inches='tight', dpi=1000)
