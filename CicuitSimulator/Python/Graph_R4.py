...
img = mpimg.imread('Resources/R4.png')											#Memuat file .png ke variabel img
...
fig1.canvas.set_window_title('Gambar Rangkaian 4')								#Mengubah window title
...
#Membaca file csv
data = pd.read_csv(r"Output\R4.csv")
...
tegangan = pd.concat([va,vb,vc], axis = 1)
...
fig2.canvas.set_window_title('Grafik Tegangan dan Arus Rangkaian 4')

#Menyimpan figure 2 dalam bentuk png
plt.savefig('Output\R4.png', bbox_inches='tight', dpi=1000)
