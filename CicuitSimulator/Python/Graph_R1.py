...
img = mpimg.imread('Resources/R1.png')											#Memuat file .png ke variabel img
...
fig1.canvas.set_window_title('Gambar Rangkaian 1')								#Mengubah window title
...
#Membaca file csv
data = pd.read_csv(r"Output\R1.csv")
...
arus = pd.concat([i1], axis = 1)
tegangan = pd.concat([va,vb], axis = 1)
...
fig2.canvas.set_window_title('Grafik Tegangan dan Arus Rangkaian 1')

#Menyimpan figure 2 dalam bentuk png
plt.savefig('Output\R1.png', bbox_inches='tight', dpi=1000)
