...
img = mpimg.imread('Resources/R6.png')											#Memuat file .png ke variabel img
...
fig1.canvas.set_window_title('Gambar Rangkaian 6')								#Mengubah window title
...
#Membaca file csv
data = pd.read_csv(r"Output\R6.csv")
...
fig2.canvas.set_window_title('Grafik Tegangan dan Arus Rangkaian 6')

#Menyimpan figure 2 dalam bentuk png
plt.savefig('Output\R6.png', bbox_inches='tight', dpi=1000)
